...
summary: Designed the interface layer for Caterpillar's power generation control
  hardware, end-to-end requirements to design to user testing along with bench
  setup for validation and verification.
---
## The Problem
...
I was brought on as UX Systems Engineer with design, user testing, verification and validation responsibilities to create a cohesive HMI for a new class of Caterpillar generator control hardware, building both the visual design system and the product development process.
...
Studied generator operator workflows across single-gen and grid-parallel environments. Mapped navigation flows, updated UI design screens using ECS Design System from Mannheim.
